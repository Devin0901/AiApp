...
const RecipeDetailHealty = () => {
    ...
    const handleRecipeHowToHealty = () => {
        navigation.navigate('RecipeHowToHealty')
    }
    ...
    return (
        <View contentContainerStyle={styles.container}>
            ...
            <View style = {styles.textContainer}>
                ...
                <TouchableOpacity style ={styles.boxHowTo} onPress = {handleRecipeHowToHealty}>
...
export default RecipeDetailHealty;
